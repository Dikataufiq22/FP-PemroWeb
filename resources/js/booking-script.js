...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const pickupRadios = document.querySelectorAll(
    ...
    function setupEventListeners() {
        ...
        document
            ...
            .addEventListener("click", saveBookingDraft);
        document
            .getElementById("clearBooking")
            .addEventListener("click", clearBooking);
    }
    ...
    function loadSelectedBooking() {
        ...
        const selectedItem = Array.from(productItems).find(
...
`;
                      ...
                      <div class="selected-item-info">
                        ...
                        item.name
                          ...
                          <div class="selected-item-details">
                              <h6>${item.name}</h6>
                              <div class="selected-item-price">Rp.${
                                  item.price
                              }/hari</div>
                          </div>
                      </div>
                      <div class="quantity-controls">
                          <button type="button" class="quantity-btn" onclick="updateItemQuantity('${
                              item.id
                          }', ${item.quantity - 1})">
                          ...
                          <button type="button" class="btn btn-outline-danger btn-sm ms-2" onclick="removeItem('${
                              item.id
                          }')">
    ...
    function updateConfirmationPage() {
        // Update items list
        const confirmationItemsList = document.getElementById(
        ...
        // Update details
        document.getElementById("confirmStartDate").textContent =
            startDate.value;
        ...
        document.getElementById("confirmIdNumber").textContent =
                ...
                if (responseMessage) {
                    if (error.errors) {
                        ...
                        for (const key in error.errors) {
                            errorMessage += `<li>${error.errors[key]}</li>`;
                        }
                        errorMessage += "</ul>";
    ...
    function saveBookingDraft() {
        const bookingData = {
            ...
            pickupMethod: document.querySelector(
                'input[name="pickup_method"]:checked'
            )?.value,
        ...
        if (savedData) {
            try {
                ...
                if (bookingData.startDate)
                    startDate.value = bookingData.startDate;
                ...
                if (bookingData.pickupMethod) {
                    document.querySelector(
                        `input[name="pickup_method"][value="${bookingData.pickupMethod}"]`
                    ).checked = true;
